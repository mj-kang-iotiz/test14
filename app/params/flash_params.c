...
void flash_params_set_ntrip_mountpoint(const char *mountpoint) {
    strncpy(current_params.ntrip_mountpoint, mountpoint,
            sizeof(current_params.ntrip_mountpoint) - 1);
    current_params.ntrip_mountpoint[sizeof(current_params.ntrip_mountpoint) - 1] = '\0';
}

void flash_params_set_manual_position(uint32_t use_manual, const char *lat, const char *lon,
                                      const char *alt) {
