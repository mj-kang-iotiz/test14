...
static const at_cmd_entry_t at_cmd_table[] = {{"AT+GPSMANUF?", at_gps_manuf_handler},
...
static void at_read_config_handler(const char *param) {
    ...
    sprintf(resp_str, "+CONFIG=%s,%s,%s,%s,%s,%s,%s,%s,%s,%lf,%s\r", params->ntrip_url,
            params->ntrip_port, params->ntrip_id, params->ntrip_pw, params->ntrip_mountpoint,
            params->use_manual_position ? "MANUAL" : "AUTO", params->lat, params->lon, params->alt,
            params->baseline_len, params->ble_device_name);
