...
void rs485_init_all(void) {
    ...
    BaseType_t ret = xTaskCreate(rs485_rx_task, "rs485_rx", 512, (void *)&rs485_instance,
    ...
    ret = xTaskCreate(rs485_tx_task, "rs485_tx", 512, (void *)&rs485_instance, tskIDLE_PRIORITY + 3,
                      &rs485_instance.tx_task);
    ...
    gps_send_timer = xTimerCreate("GPS_Send",             // Timer name
...
char *CONFIG_Response =
    "+CONFIG=Hello1234567890abcdefghijklmnopqrstuvwyzABCDEFGHIJKLMNOPQRSTUVWXYZ\r"; // need make CONFIG Variable
...
static void rs485_task(void *pvParameter) {
    ...
    while (1) {
        ...
        if (strcmp(rx_buffer, "AT\r") == 0) {
            ...
            else if (config->board == BOARD_TYPE_BASE_F9P ||
                     config->board == BOARD_TYPE_ROVER_F9P) {
