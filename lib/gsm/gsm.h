...
typedef void (*evt_handler_t)(gsm_evt_t evt, void *args); ///< GSM 이벤트 발생시, 사용하는 콜백함수
...
//       }
//   }
typedef void (*at_cmd_handler)(gsm_t *gsm, gsm_cmd_t cmd, void *msg, bool is_ok);
...
void gsm_send_at_qisde(gsm_t *gsm, gsm_at_mode_t at_mode, uint8_t echo_on, at_cmd_handler callback);
...
void gsm_send_at_qicfg_keepalive(gsm_t *gsm, uint8_t enable, uint16_t keepidle,
                                 uint16_t keepinterval, uint8_t keepcount, at_cmd_handler callback);
