 ...
 * @return true: 큐 추가 성공
 */
bool lora_send_cmd_async(lora_t *lora, const char *cmd, uint32_t timeout_ms, uint32_t toa_ms,
 ...
 * @return true: 큐 추가 성공
 */
bool lora_send_p2p_raw(lora_t *lora, const uint8_t *data, size_t len, uint32_t timeout_ms,
